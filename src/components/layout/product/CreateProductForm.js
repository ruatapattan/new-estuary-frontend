    ...
    >
      ...
      <Box sx={{ paddingTop: '30px' }}>
        ...
        <label htmlFor="contained-button-file">
          <Input id="contained-button-file" multiple type="file" sx={{ display: 'none' }} />
      ...
      >
        ...
        <TextField id="standard-multiline-static" label="Description" multiline sx={textFieldStyle} />
        <TextField id="outlined-select-currency" select label="Collection" sx={textFieldStyle} />
